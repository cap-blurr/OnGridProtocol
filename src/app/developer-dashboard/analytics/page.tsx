...
export default function EnergyProductionAnalytics() {
  ...
  const getTypeIcon = (type: string) => {
    switch (type) {
      case 'Solar': return <Sun className="w-5 h-5 text-[#4CAF50]" />;
      case 'Wind': return <Wind className="w-5 h-5 text-blue-400" />;
      default: return <Zap className="w-5 h-5 text-[#4CAF50]" />;
    }
  };
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-8">
          ...
          <Card className="relative bg-black/40 backdrop-blur-sm border border-[#4CAF50]/30 overflow-hidden">
            ...
            <CardContent className="relative">
              ...
              <p className="text-xs text-[#4CAF50]">MWh this month</p>
            </CardContent>
          </Card>
          ...
          <Card className="relative bg-black/40 backdrop-blur-sm border border-[#4CAF50]/30 overflow-hidden">
            ...
            <CardContent className="relative">
              <div className="text-2xl font-bold text-[#4CAF50]">{avgEfficiency.toFixed(1)}%</div>
              <p className="text-xs text-[#4CAF50]">Performance ratio</p>
            </CardContent>
          </Card>
          ...
          <Card className="relative bg-black/40 backdrop-blur-sm border border-[#4CAF50]/30 overflow-hidden">
            ...
            <CardContent className="relative">
              ...
              <p className="text-xs text-[#4CAF50]">tons this month</p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="space-y-6">
          {energyData.map((project) => (
            <Card key={project.id} className="relative bg-black/40 backdrop-blur-sm border border-[#4CAF50]/30 overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-br from-[#4CAF50]/20 to-transparent pointer-events-none" />
                ...
                <div className="flex flex-col lg:flex-row lg:items-center justify-between">
                  <div className="flex items-center space-x-3 mb-4 lg:mb-0">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-[#4CAF50]">{project.type} Energy • {project.capacity} Capacity</p>
                    </div>
                  </div>
              ...
              <CardContent className="relative">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                  {/* Current Output */}
                  <div className="text-center p-4 bg-gray-800/50 rounded-lg border border-[#4CAF50]/20">
                    <Activity className="w-6 h-6 text-green-400 mx-auto mb-2" />
                    <p className="text-2xl font-bold text-white">{project.currentOutput}</p>
                    <p className="text-sm text-[#4CAF50]">Current Output</p>
                  ...
                  {/* Efficiency */}
                  <div className="text-center p-4 bg-gray-800/50 rounded-lg border border-[#4CAF50]/20">
                    <TrendingUp className="w-6 h-6 text-[#4CAF50] mx-auto mb-2" />
                    <p className="text-2xl font-bold text-white">{project.efficiency}%</p>
                    <p className="text-sm text-[#4CAF50]">Efficiency</p>
                    <div className="w-full bg-gray-700 rounded-full h-2 mt-2">
                      <div 
                        className="bg-gradient-to-r from-[#4CAF50] to-[#4CAF50] h-2 rounded-full transition-all duration-300"
                  ...
                  <div className="text-center p-4 bg-gray-800/50 rounded-lg border border-[#4CAF50]/20">
                    ...
                    <p className="text-sm text-[#4CAF50]">MWh/Month</p>
                  ...
                  <div className="text-center p-4 bg-gray-800/50 rounded-lg border border-[#4CAF50]/20">
                    ...
                    <p className="text-sm text-[#4CAF50]">CO₂ Tons Saved</p>
                ...
                <div className="flex flex-col sm:flex-row gap-3 pt-4 border-t border-gray-700/50">
                  <Button className="bg-gradient-to-r from-[#4CAF50] to-[#4CAF50] hover:from-[#4CAF50]/90 hover:to-[#4CAF50]/90 text-white font-medium transition-all duration-200">
